...
String? _selectedSymptom; // Nullable for no selection initially

// List of symptom options for the dropdown
...
Widget build(BuildContext context) {
	// Access the current theme's color scheme for adaptive colors
